...
<head>
    ...
    <title><?php if ($page['meta_title']) { ?><?= $page['meta_title'] ?><?php } else { ?><?= $page['name'] ?><?php } ?></title>
...
<div id="page">
    ...
    <?php $this->partial('templates/pages/singl', ['page' => $page]); ?>
...
<?php } ?>
    ...
    <?php $this->partial('templates/comments/comments', ['comments' => $comments, 'type' => 'page', 'id' => $page['id_page'], 'count' => $countComments]); ?>
